...
Create Table App_User (
    ...
    Password_Hash CHAR(88) NOT NULL DEFAULT '058FkO+Yx5K22E4qnuJ8v+1LbLqKCCm3W1zkdU3r74+Z73Gv3wU7EYh7p5yUBPjAwu+28jKQVQv21PbpnUUwBg==' COMMENT 'Password Hass of the User',-- Need to change once we know what the hash will be for the default user.
